...
public static class BezierCurveSerializer
{
    ...
    public static BezierCurve DeserializeFromFile(string filePath, CustomCanvas canvas)
    {
        ...
        //    Style = new()
        //    {
        //        FillColor = !string.IsNullOrEmpty(dto.Fill) ? (Brush)new BrushConverter().ConvertFromString(dto.Fill) : null,
        //        StrokeThickness = dto.StrokeThickness,
        //        StrokeColor = !string.IsNullOrEmpty(dto.Stroke) ? (Brush)new BrushConverter().ConvertFromString(dto.Stroke) : null,
        //    }
        //};
